...
jobTriggered: 'Job acionado',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      value: 'Valor', invalidConditionValue: 'O valor da condição deve ser JSON válido', conditionValuePlaceholder: 'JSON: "texto", 42, true, ["a"]', valueHelp: 'Insira JSON válido. Texto precisa de aspas duplas; tipos não são convertidos.',
