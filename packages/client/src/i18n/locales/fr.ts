...
jobTriggered: 'Job declenche',
  ...
  githubPreview: {
    ...
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données Web UI. La production reste sur le port 56278 ; la prévisualisation utilise le frontend 56281 et le backend 56280.",
