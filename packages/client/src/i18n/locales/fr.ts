...
jobTriggered: 'Job declenche',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      value: 'Valeur', invalidConditionValue: 'La valeur de condition doit être un JSON valide', conditionValuePlaceholder: 'JSON : "texte", 42, true, ["a"]', valueHelp: 'Saisissez du JSON valide. Le texte exige des guillemets doubles ; aucun changement de type.',
