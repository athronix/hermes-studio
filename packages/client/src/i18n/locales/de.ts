...
jobTriggered: 'Job ausgelost',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      value: 'Wert', invalidConditionValue: 'Der Bedingungswert muss gültiges JSON sein', conditionValuePlaceholder: 'JSON: "Text", 42, true, ["a"]', valueHelp: 'Gültiges JSON eingeben. Text braucht doppelte Anführungszeichen; Typen werden nicht umgewandelt.',
