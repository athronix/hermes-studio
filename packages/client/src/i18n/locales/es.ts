...
jobTriggered: 'Job ejecutado',
  ...
  githubPreview: {
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de Web UI. Producción sigue en el puerto 56278; la vista previa usa frontend 56281 y backend 56280.",
