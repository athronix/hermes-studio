...
jobTriggered: 'Job ejecutado',
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      value: 'Valor', invalidConditionValue: 'El valor de condición debe ser JSON válido', conditionValuePlaceholder: 'JSON: "texto", 42, true, ["a"]', valueHelp: 'Introduce JSON válido. El texto necesita comillas dobles; no hay conversión de tipos.',
