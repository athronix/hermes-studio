export default {
  ...
  workflow: {
    ...
    edgeEditor: {
      ...
      value: '값', invalidConditionValue: '조건 값은 유효한 JSON이어야 합니다', conditionValuePlaceholder: 'JSON: "텍스트", 42, true, ["a"]', valueHelp: '유효한 JSON을 입력하세요. 텍스트에는 큰따옴표가 필요하며 형식 변환은 하지 않습니다.',
