!macro stopHermesStudioProcesses
  ...
  hermesStudioSkipQuitSignal:
    ...
    FileWrite $0 "$$targetDirs = New-Object 'System.Collections.Generic.HashSet[string]' ([System.StringComparer]::OrdinalIgnoreCase)$\r$\n"
    ...
    FileWrite $0 "  $$dir = [System.IO.Path]::GetDirectoryName($$full)$\r$\n"
    FileWrite $0 "  if ($$dir) { $$null = $$targetDirs.Add($$dir.TrimEnd('\')) }$\r$\n"
    FileWrite $0 "}$\r$\n"
    ...
    FileWrite $0 "      foreach ($$dir in $$dirs) { if ($$full.StartsWith($$dir + '\', [System.StringComparison]::OrdinalIgnoreCase)) { return $$true } }$\r$\n"
